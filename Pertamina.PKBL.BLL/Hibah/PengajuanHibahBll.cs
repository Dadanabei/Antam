...
{
    public partial class PengajuanHibahBll
    {
        ...
        public DataTable GetData(string branchCode)
        {
            ...
            try
            {
                return dbHelper.GetData("[USP_HIBAH_PERMOHONAN_SELECT]", parameters);
            }
            catch (Exception e)
            {
                throw e;
        ...
        public int InsertData(Hashtable parameters)
        {
            try
            {
                return dbHelper.ExecuteNonQuery("[USP_HIBAH_PERMOHONAN_INSERT]", parameters);
            }
            catch (Exception e)
            {
