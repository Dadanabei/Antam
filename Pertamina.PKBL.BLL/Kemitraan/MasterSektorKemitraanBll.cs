...
{
    public class MasterSektorKemitraanBll
    {
        ...
        public DataTable GetData(Hashtable parameters)
        {
            try
            {
                return dbHelper.GetData("[USP_SEKTOR_KEMITRAAN_SELECT]", parameters);
            }
            catch (Exception e)
            {
        ...
        public void InsertData(Hashtable parameters)
        {
            try
            {
                dbHelper.ExecuteNonQuery("[USP_SEKTOR_KEMITRAAN_INSERT]", parameters);
            }
            catch (Exception e)
            {
        ...
        public void UpdateData(Hashtable parameters)
        {
            try
            {
                dbHelper.ExecuteNonQuery("[USP_SEKTOR_KEMITRAAN_UPDATE]", parameters);
            }
            catch (Exception e)
            {
        ...
        public void DeleteData(Hashtable parameters)
        {
            try
            {
                dbHelper.ExecuteNonQuery("[USP_SEKTOR_KEMITRAAN_DELETE]", parameters);
            }
            catch (Exception e)
            {
