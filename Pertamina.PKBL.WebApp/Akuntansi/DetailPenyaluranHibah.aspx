<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="DetailPenyaluranHibah.aspx.cs" Inherits="Pertamina.PKBL.WebApp.Akuntansi.DetailPenyaluranHibah" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContent" runat="server">
    ...
    <dx:ASPxGridView runat="server" ID="gvDetailPenyaluranHibah" AutoGenerateColumns="False" Theme="Youthful" Width="100%">
        <Columns>
    ...
    <div class="borderdetail">
        ...
        <table style="width:60%">
            ...
            <tr>
                <td>
                    <dx:ASPxLabel runat="server" ID="lblJumlahPencairan" Text="Jumlah Penyaluran"></dx:ASPxLabel>
                    <span style="color:red">*</span>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <dx:ASPxLabel runat="server" ID="lblAkunLawan" Text="Lawan Akun"></dx:ASPxLabel>
                    <span style="color:red">*</span>
                </td>
                <td>
                   <dx:ASPxComboBox runat="server" ID="cbLawanAkun" Theme="Youthful" Width="100%" IncrementalFilteringMode="StartsWith" >
                       <ValidationSettings Display="Dynamic" ErrorDisplayMode="ImageWithTooltip" >
                            <RequiredField IsRequired="true" ErrorText=" " />
                        </ValidationSettings>
                   </dx:ASPxComboBox>
        ...
        <dx:ASPxHyperLink ID="ASPxHyperLink1" runat="server" Text="Cancel" NavigateUrl="~/Akuntansi/PenyaluranHibah.aspx"></dx:ASPxHyperLink>
        <br />
        <br />
