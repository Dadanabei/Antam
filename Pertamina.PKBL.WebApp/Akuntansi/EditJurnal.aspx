<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="EditJurnal.aspx.cs" Inherits="Pertamina.PKBL.WebApp.Akuntansi.EditJurnal" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContent" runat="server">
                    ...
                    <div class="borderdetail">
                        <table style="width: 60%;">
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <dx:ASPxTextBox ID="txtNilai" runat="server" Theme="Youthful" Width="60%" class="form-control" ClientIDMode="Static">
                        ...
                        <br />
                        <dx:ASPxButton ID="btnTambah" runat="server" Text="Tambah" Theme="Youthful" ></dx:ASPxButton>
    ...
    <dx:ASPxGridView runat="server" ID="gvDetailKas" Width="100%" Theme="Youthful" KeyFieldName="id" 
    ...
    <dx:ASPxButton ID="btnSimpan" runat="server" Text="Simpan" Theme="Youthful"></dx:ASPxButton>
