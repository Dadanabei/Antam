<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DaftarAdjustment.ascx.cs" Inherits="Pertamina.PKBL.WebApp.Akuntansi.JurnalAdjustmentControl.DaftarAdjustment" %>
...
<div class="borderdetail">
    ...
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxButton runat="server" ID="btnFilter" Text="Filter" Theme="Youthful" OnClick="btnFilter_Click" AutoPostBack="true"></dx:ASPxButton>
            </td>
        </tr>
    </table>
    </div>
    ...
    <dx:ASPxGridView runat="server" KeyFieldName="IdJurnalKasDetail"  ID="gvDaftarJrnal" AutoGenerateColumns="False" EnableTheming="True" 
        Theme="Youthful" Width="100%" ClientInstanceName="gvDaftarJrnal" ClientSideEvents-CustomButtonClick="Change" OnCustomButtonCallback="gvDaftarJrnal_CustomButtonCallback"
        ...
        <Columns>
            ...
            <dx:GridViewCommandColumn Caption="Opr."  VisibleIndex="5" ButtonType="Image" ShowClearFilterButton="True">
                 <CustomButtons>
