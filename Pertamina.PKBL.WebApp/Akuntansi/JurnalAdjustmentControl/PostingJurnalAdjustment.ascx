<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PostingJurnalAdjustment.ascx.cs" Inherits="Pertamina.PKBL.WebApp.Akuntansi.JurnalAdjustmentControl.PostingJurnalAdjustment" %>
...
<div id="tabs">
    ...
    <dx:ASPxGridView runat="server" ID="gvDetailKas" Width="100%" Theme="Youthful" KeyFieldName="id" OnRowUpdating="gvDetailKas_RowUpdating"
        ...
        <Columns>
            <dx:GridViewCommandColumn Caption="Opr." Name="opr" ShowDeleteButton="True" ShowEditButton="True" VisibleIndex="7">
