...
{
    public partial class PostingJurnalAdjustment : System.Web.UI.UserControl
    {
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (Sisa == 0)
                {
                    ...
                    ht.Add("@Noref-varchar-40", bll.NoRefJurnalPenyesuaian(branchCode));
                    ...
                    if (bll.InsertJurnal(ht))
                    {
                        ...
                        Response.Redirect("~/Akuntansi/Adjustment.aspx");
        ...
        protected void cbbJenisProgram_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (cbbJenisProgram.Value.ToString() == "1")
            {
                ...
                lblHeader.Text = "JURNAL ADJUSTMENT : Program Kemitraan";
            }
            ...
            else if (cbbJenisProgram.Value.ToString() == "2")
            {
                ...
                lblHeader.Text = "JURNAL ADJUSTMENT : Bina Linkungan";
            }
            ...
            else if (cbbJenisProgram.Value.ToString() == "3")
            {
                ...
                lblHeader.Text = "JURNAL ADJUSTMENT : Program Kemitraan dan Bina Lingkungan";
            }
        }
