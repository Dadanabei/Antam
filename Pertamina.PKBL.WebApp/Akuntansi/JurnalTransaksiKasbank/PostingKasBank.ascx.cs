...
{
    public partial class PostingKasBank : System.Web.UI.UserControl
    {
        ...
        private void roleAuth()
        {
            ...
            bool insert = RoleCheck.CheckRoleView(userRoles, "AKUN.JURNAL.KasBank.Add");
            bool edit = RoleCheck.CheckRoleView(userRoles, "AKUN.JURNAL.KasBank.Edit");
            bool view = RoleCheck.CheckRoleView(userRoles, "AKUN.JURNAL.KasBank.View");
            bool delete = RoleCheck.CheckRoleView(userRoles, "AKUN.JURNAL.KasBank.Delete");
        ...
        private void ComboKasBank(int jenis, string branchCode)
        {
            var akun = bll.GetAkunKasBank(jenis, branchCode);
        ...
        protected void btnSimpan_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                var data = (DataTable)Session["Report"];
                var branchCode = ((wcf_auth.GeneralUserProfile)Session["userprofile"]).mAuthObjectValueList.FirstOrDefault(t => t.mAuthObjectName == "REGION").Value1;
                string date = Convert.ToDateTime(deTglBukti.Value).ToString("dd/MM/yyyy");
                ...
                if (Sisa == 0)
                {
                    ...
                    ht.Add("@Noref-varchar-40", bll.NoRefJurnalKasBank(branchCode));
                    ...
                    if (bll.InsertJurnal(ht))
                    {
                        ...
                        Response.Redirect("~/Akuntansi/TransaksiKasBank.aspx");
            ...
            {
                log.Type = "E";
                log.Description = "Insert Jurnal Kas Bank Gagal : " + ex.Message;
                //ViewState["script"] = "<script> alert('"+HttpUtility.JavaScriptStringEncode(+"');</script>"
        ...
        {
            string branchCode = ((wcf_auth.GeneralUserProfile)Session["userprofile"]).mAuthObjectValueList.FirstOrDefault(t => t.mAuthObjectName == "REGION").Value1;
            int jenis = Convert.ToInt32(cbbJenisProgram.Value);
            if (jenis == 1)
            {
                ComboKasBank(jenis, branchCode);
                ComboPembayaran(0, 0, 1);
                lblHeader.Text = "JURNAL KAS BANK : Program Kemitraan";
            }
            ...
            else if (jenis == 2)
            {
                ...
                lblHeader.Text = "JURNAL KAS BANK : Bina Linkungan";
            }
            ...
            else if (jenis == 3)
            {
                ...
                lblHeader.Text = "JURNAL KAS BANK : Program Kemitraan dan Bina Lingkungan";
            }
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            var data = ((DataTable)Session["Report"]).Copy();
            var branchCode = ((wcf_auth.GeneralUserProfile)Session["userprofile"]).mAuthObjectValueList.FirstOrDefault(t => t.mAuthObjectName == "REGION").Value1;
            string date = Convert.ToDateTime(deTglBukti.Value).ToString("dd/MM/yyyy");
            int jnsProgram = Convert.ToInt32(cbbJenisProgram.Value);
            int jnsPembayaran = Convert.ToInt32(cbbJenisPembayaran.Value);
            ...
            if (Sisa == 0)
            {
                ...
                Session["printPreviewJurnal"] = ht;

                ViewState["script"] = "<script>window.open('../Reporting/PrintPage.aspx');</script>";
