<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DaftarJurnalUmum.ascx.cs" Inherits="Pertamina.PKBL.WebApp.Akuntansi.Jurnal_Umum_Control.DaftarJurnalUmum" %>
...
<div class="borderdetail">
    ...
    <table>
        <tr>
            ...
            <td>
                <dx:ASPxTextBox ID="txtNoBkti" runat="server" Width="250px" Theme="Youthful">
                </dx:ASPxTextBox>
            </td>
            <td style="width:20px">
    ...
    <br />
    <dx:ASPxGridView runat="server" ID="gvDaftarJrnal" AutoGenerateColumns="False" KeyFieldName="IdJurnalKasDetail" 
        Theme="Youthful" Width="100%" ClientInstanceName="gvDaftarJrnal" ClientSideEvents-CustomButtonClick="Change" 
        OnCustomButtonCallback="gvDaftarJrnal_CustomButtonCallback" OnHtmlRowPrepared="gvDaftarJrnal_HtmlRowPrepared" Visible="false" >
        <Columns>
