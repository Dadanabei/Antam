<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PostingJournal.ascx.cs" Inherits="Pertamina.PKBL.WebApp.Akuntansi.Jurnal_Umum_Control.PostingJournal" %>
...
<div id="tabs">
                    ...
                    <tr>
                        ...
                        <td>
                            <dx:ASPxComboBox ID="cbbJenisProgram" Theme="Youthful" runat="server" ValueType="System.String"
                                ClientSideEvents-Init="Init" OnSelectedIndexChanged="cbbJenisProgram_SelectedIndexChanged" AutoPostBack="true">
                                <Items>
            ...
            <div id="Panel" runat="server">
                <div class="bodydetail">
                    <div class="borderdetail">
                        <table style="width: 60%;">
                            <tr>
                                ...
                                <td>
                                    <dx:ASPxDateEdit ID="deTglBukti" AllowUserInput="false" runat="server" Theme="Youthful" >
                                    </dx:ASPxDateEdit>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <dx:ASPxTextBox ID="txtJnsPembayaran" runat="server" Width="60%" Visible="false" class="form-control" ClientIDMode="Static"></dx:ASPxTextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td>Verifikasi:<font color='red'>*</font>
                                </td>
                                <td>
                    ...
                    <div class="borderdetail">
                        ...
                        <br />
                        <dx:ASPxButton ID="btnTambah" runat="server" Text="Tambah" Theme="Youthful" OnClick="btnTambah_Click"></dx:ASPxButton>
    ...
    <dx:ASPxGridView runat="server" ID="gvDetailKas" Width="100%" Theme="Youthful" KeyFieldName="id" AutoGenerateColumns="False"
         OnRowUpdating="gvDetailKas_RowUpdating" OnRowDeleting="gvDetailKas_RowDeleting" OnHtmlRowPrepared="gvDetailKas_HtmlRowPrepared">
        <Columns>
