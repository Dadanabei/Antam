<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Daftar CIF.ascx.cs" Inherits="Pertamina.PKBL.WebApp.BinaLingk.UserControlBl.Daftar_CIF" %>
           ...
           KeyFieldName="account_id" >
            <Columns>
                ...
                <dx:GridViewDataTextColumn Caption="Nama" Name="branch_code" VisibleIndex="2" Width="15%" >
                 ...
                 <dx:GridViewDataTextColumn Caption="No Proposal"  VisibleIndex="2" Width="10%" >
                </dx:GridViewDataTextColumn>
                 <dx:GridViewDataTextColumn Caption="JBL"  VisibleIndex="2" Width="5%" >
                </dx:GridViewDataTextColumn>
                 <dx:GridViewDataTextColumn Caption="OPR" Name="branch_code" VisibleIndex="2" Width="2" >
                </dx:GridViewDataTextColumn>
