<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="List Survei Diterima.ascx.cs" Inherits="Pertamina.PKBL.WebApp.BinaLingk.UserControlBl.List_Survei_Diterima" %>
