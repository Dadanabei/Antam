<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BinLingDaftarDisetujuiUserControl.ascx.cs" Inherits="Pertamina.PKBL.WebApp.BinaLingk.PersetujuanBLUserControls.BinLingDaftarDisetujuiUserControl" %>
