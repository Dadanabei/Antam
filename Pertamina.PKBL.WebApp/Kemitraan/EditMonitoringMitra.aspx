<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="EditMonitoringMitra.aspx.cs" Inherits="Pertamina.PKBL.WebApp.Kemitraan.EditMonitoringMitra" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="BodyContent" runat="server">
    <span style="font-size:large">Edit Monitoring Evaluasi</span>
    <br />
    <div class="borderdetail">
        <table>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxDateEdit runat="server" ID="txtTangal" Theme="Youthful"></dx:ASPxDateEdit>
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <dx:ASPxTextBox runat="server" ID="txtJumlahTenaga" Theme="Youthful"></dx:ASPxTextBox><span style="font-size:x-small">orang</span>
                </td>
            </tr>
             <tr>
                <td>
                ...
                <td>
                    <dx:ASPxTextBox runat="server" ID="txtOmzet" Theme="Youthful"></dx:ASPxTextBox><span style="font-size:x-small">/bulan (rata-rata)</span>
                </td>
            </tr>
             <tr>
                <td>
                ...
                <td>
                    <dx:ASPxTextBox runat="server" ID="txtPenjualan" Theme="Youthful"></dx:ASPxTextBox><span style="font-size:x-small">/bulan</span>
                </td>
            </tr>           
        </table>
    </div>
    ...
    <div class="borderdetail">
        <table>
            <tr>
                ...
                <td>
                    <dx:ASPxTextBox runat="server" ID="txtJumlahPeng" Theme="Youthful"></dx:ASPxTextBox><span style="font-size:x-small">/bulan</span>
                </td>
            </tr>
            <tr>
                <td>
        ...
        <table class="full">
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    <dx:ASPxTextBox runat="server" ID="txtAset" Theme="Youthful"></dx:ASPxTextBox>
                </td>
            </tr>
    ...
    <dx:ASPxButton runat="server" ID="btnSimpan" Text="Simpan" Theme="Youthful"></dx:ASPxButton>&nbsp;<dx:ASPxHyperLink runat="server" ID="btnKembali" Text="Kembali"></dx:ASPxHyperLink>
